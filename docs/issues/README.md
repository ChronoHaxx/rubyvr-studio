...
| RV-003 | [Add the first versioned authored terrain surface and shared height query](003-terrain-contract.md) | M2 | terrain/connected explorer and model reuse/six-map view merged through PR #31; streaming and geography pending |

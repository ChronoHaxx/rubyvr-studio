...
"$compiler" -std=c++20 -O2 -Wall -Wextra -Werror -pedantic -Isrc/vr \
    tools/npc-frame-test.cpp src/vr/actor_frame.cpp -o build/npc-frame-test
env -u DISPLAY -u WAYLAND_DISPLAY ./build/npc-frame-test
"$compiler" -std=c++20 -O1 -g -fsanitize=address,undefined -fno-omit-frame-pointer -Isrc/vr \
    tools/npc-frame-test.cpp src/vr/actor_frame.cpp -o build/npc-frame-test-sanitized
env -u DISPLAY -u WAYLAND_DISPLAY ./build/npc-frame-test-sanitized
